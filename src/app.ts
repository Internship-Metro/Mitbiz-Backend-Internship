...
import superAdminSubscriptionRoutes from './modules/super-admin/subscription/subscription.routes';
...
import posConfigRoutes from './modules/pos/config/pos-config.routes';
...
app.use('/api/v1/superadmin/subscriptions', superAdminSubscriptionRoutes);
...
app.use('/api/v1/pos', posConfigRoutes);
